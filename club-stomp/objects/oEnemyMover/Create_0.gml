...
standoff = 10*512; //distance the cycler will hold from player
tolerance = 5*512; //distance from standoff where the enemy won't correct it's distance
...
doFireControl = function() //handles enemy attacks
{
	...
	else if (canSee(target, range)) //only shoot if player is visible
	{
